...
RSpec.describe Character, type: :model do
  ...
  it { should have_many(:character_traits).inverse_of(:character).dependent(:destroy) }
  it { should have_many(:traits).through(:character_traits).inverse_of(:characters) }

  it { should have_many(:character_items).inverse_of(:character).dependent(:destroy) }
  it { should have_many(:items).through(:character_items).inverse_of(:characters) }
